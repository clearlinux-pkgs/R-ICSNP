...
Version  : 1.1.2
Release  : 54
URL      : https://cran.r-project.org/src/contrib/ICSNP_1.1-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ICSNP_1.1-2.tar.gz
...
%setup -q -n ICSNP
pushd ..
cp -a ICSNP buildavx2
popd
pushd ..
cp -a ICSNP buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737147338
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/ICSNP/libs/ICSNP.so
/V4/usr/lib64/R/library/ICSNP/libs/ICSNP.so
